...
const ContasReceber = () => {
  ...
  const getStatusBadge = (status) => {
    const styles = {
      ...
      'PARCIAL': 'bg-indigo-500/10 text-indigo-500 border-indigo-500/20'
    };
    return (
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium">
            Gestão de faturamento, clientes e fluxo de entradas.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-emerald-600 text-white rounded-2xl text-sm font-black uppercase tracking-widest shadow-lg shadow-emerald-600/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
          >
            <Plus size={18} />
            Novo Título
          </button>
